...
@Component({
  selector: 'app-ventasterrenospormes',
  templateUrl: './ventasterrenospormes.component.html',
  styleUrl: './ventasterrenospormes.component.scss'
})
export class VentasterrenospormesComponent {
  barData: any;
  barOptions: any;
  pieOptions: any;
  ...
  comprasrealizadas(){
    ...
    this.servicio.VentasTerrenosPorMes(formattedFechaInicio, formattedFechaFinal).subscribe(
        (data: any[]) => {
