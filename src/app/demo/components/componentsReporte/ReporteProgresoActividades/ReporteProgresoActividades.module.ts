...
import { categoriaviaticoRoutingModule } from "./ReporteProgresoActividades-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteProgresoActividadesComponent
    ]
  })
  export class ReporteProgresoActividadesComponentaModule { }
