...
import { categoriaviaticoRoutingModule } from "./ReporteTerrenosPorEstadoProyecto-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteTerrenosPorEstadoProyectoComponent
    ]
  })
  export class ReporteTerrenosPorEstadoProyectoModule { }
