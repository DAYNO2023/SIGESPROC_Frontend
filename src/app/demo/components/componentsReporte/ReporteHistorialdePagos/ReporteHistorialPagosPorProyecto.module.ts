...
import { categoriaviaticoRoutingModule } from "./ReporteHistorialPagosPorProyecto-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteHistorialPagosPorProyectoComponent
    ]
  })
  export class ReporteHistorialPagosPorProyectoComponentaModule { }
