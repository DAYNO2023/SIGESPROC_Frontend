...
import { categoriaviaticoRoutingModule } from "./ReportecomprasPendientesEnvio-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReportecomprasPendientesEnvioComponent
    ]
  })
  export class ReportecomprasPendientesEnvioComponentaModule { }
