...
import { categoriaviaticoRoutingModule } from "./ReporteInsumosTransportadosPorActividad-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteInsumosTransportadosPorActividadComponent
    ]
  })
  export class ReporteInsumosTransportadosPorActividadComponentaModule { }
