...
import { categoriaviaticoRoutingModule } from "./EstadisticasFletes_Llegada-routing.module";
...
@NgModule({
    ...
    declarations: [
      EstadisticasFletes_LlegadaComponent
    ]
  })
  export class EstadisticasFletes_LlegadaComponentaModule { }
