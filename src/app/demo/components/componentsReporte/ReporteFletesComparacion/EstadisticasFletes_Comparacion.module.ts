...
import { categoriaviaticoRoutingModule } from "./EstadisticasFletes_Comparacion-routing.module";
...
@NgModule({
    ...
    declarations: [
      EstadisticasFletes_ComparacionComponent
    ]
  })
  export class EstadisticasFletes_ComparacionComponentaModule { }
