...
import { categoriaviaticoRoutingModule } from "./ReporteInsumosAProyecto-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteInsumosAProyectoComponent
    ]
  })
  export class ReporteInsumosAProyectoComponentaModule { }
