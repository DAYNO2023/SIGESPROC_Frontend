...
import { categoriaviaticoRoutingModule } from "./ReporteCotizacionesPorRangoPrecios-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteCotizacionesPorRangoPreciosComponent
    ]
  })
  export class ReporteCotizacionesPorRangoPreciosComponentaModule { }
