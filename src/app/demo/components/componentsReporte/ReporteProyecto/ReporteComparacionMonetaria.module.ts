...
import { categoriaviaticoRoutingModule } from "./ReporteComparacionMonetaria-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteComparacionMonetariaComponent
    ]
  })
  export class ReporteComparacionMonetariaComponentaModule { }
