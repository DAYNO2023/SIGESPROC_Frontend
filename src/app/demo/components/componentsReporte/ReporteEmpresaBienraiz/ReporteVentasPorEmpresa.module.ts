...
import { categoriaviaticoRoutingModule } from "./ReporteVentasPorEmpresa-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteVentasPorEmpresaComponent
    ]
  })
  export class ReporteVentasPorEmpresaModule { }
