...
import { categoriaviaticoRoutingModule } from "./ReporteHistorialCotizaciones-routing.module";
...
@NgModule({
    ...
    declarations: [
      RReporteHistorialCotizacionesComponent
    ]
  })
  export class RReporteHistorialCotizacionesComponentaModule { }
