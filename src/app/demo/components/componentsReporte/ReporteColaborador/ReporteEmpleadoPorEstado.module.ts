...
import { categoriaviaticoRoutingModule } from "./ReporteEmpleadoPorEstado-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteEmpleadoPorEstadoComponent
    ]
  })
  export class ReporteEmpleadoPorEstadoComponentaModule { }
