...
import { categoriaviaticoRoutingModule } from "./ReporteProcesoVenta-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteProcesoVentaComponent
    ]
  })
  export class ReporteProcesoVentaComponentaModule { }
