...
import { categoriaviaticoRoutingModule } from "./ReporteInsumosUltimoPrecio-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteInsumosUltimoPrecioComponent
    ]
  })
  export class ReporteInsumosUltimoPrecioComponentaModule { }
