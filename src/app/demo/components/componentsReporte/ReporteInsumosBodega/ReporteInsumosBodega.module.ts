...
import { categoriaviaticoRoutingModule } from "./ReporteInsumosBodega-routing.module";
...
@NgModule({
    ...
    declarations: [
      ReporteInsumosBodegaComponent
    ]
  })
  export class ReporteInsumosBodegaComponentaModule { }
